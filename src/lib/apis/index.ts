...
export const getPipelinesList = async (token: string = '') => {
	...
	const res = await fetch(`${PIPELINES_API_BASE_URL}/list`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getPipelineValves = async (token: string, pipeline_id: string, urlIdx: string) => {
	...
	const res = await fetch(
		`${PIPELINES_API_BASE_URL}/${pipeline_id}/valves?${searchParams.toString()}`,
		{
			method: 'GET',
			headers: {
				Accept: 'application/json',
...
export const getPipelineValvesSpec = async (token: string, pipeline_id: string, urlIdx: string) => {
	...
	const res = await fetch(
		`${PIPELINES_API_BASE_URL}/${pipeline_id}/valves/spec?${searchParams.toString()}`,
		{
			method: 'GET',
			headers: {
				Accept: 'application/json',
...
export const updatePipelineValves = async (
	...
	const res = await fetch(
		`${PIPELINES_API_BASE_URL}/${pipeline_id}/valves/update?${searchParams.toString()}`,
		{
			method: 'POST',
			headers: {
				Accept: 'application/json',
